...
// Source: https://github.com/facebook/lexical/blob/main/packages/lexical-playground/src/images/icons/draggable-block-menu.svg
const draggableBlockMenuIcon = encodeURIComponent(
...
function isOnMenu(element: HTMLElement): boolean {
  return !!element.closest('[data-draggable-block]');
}
...
function useDraggableBlockMenu(
  ...
  return createPortal(
    <>
      ...
      <div
        className="pointer-events-none absolute top-0 left-0 h-1 bg-primary-300 opacity-0 will-change-transform"
        ref={targetLineRef}
      />
    </>,
    anchorElem,
