...
export interface DescriptionListAttribute {
  title: string;
  details?: ReactNode;
}
...
function AttributeSection(props: AttributeSectionProps) {
  return (
    <div
      className={clsx(
        'py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:border-b sm:border-neutral-200 sm:px-6 sm:py-3',
...
function Attribute(props: AttributeProps) {
  ...
  return (
    <div
      className={clsx(
        'group/attribute py-3 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 sm:py-5',
      ...
      {props.attachments.map((attachment) => (
        ...
        >
          <div className="flex w-0 flex-1 items-center">
            <PaperClipIcon className="size-5 shrink-0 text-neutral-400" />
