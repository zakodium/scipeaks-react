...
export function CompactTable<T extends { id: number | string }>(
  props: TableProps<T>,
) {
  const { data, Tr, Empty, Header, tableStyle, tableClassName } = props;
...
export function Td(props: TdProps) {
  ...
  return (
    <td
      className={clsx(
        'px-6 text-sm font-medium whitespace-nowrap text-neutral-900',
        props.className,
      )}
      {...otherProps}
    />
